...
function OpenModelWindow(url, option) { var fun; try { if (parent != null && parent.$ != null && parent.$.ShowIfrmDailog != undefined) fun = parent.$.ShowIfrmDailog; else fun = $.ShowIfrmDailog; } catch (e) { fun = $.ShowIfrmDailog; }  fun(url, option); }